...
//binary operators  ENSECOLAINCHI
...
var Variable = P(Symbol, function(_, super_) {
  _.init = function(ch, html) {
    let commonVars = ['x', 'y', 'z'];
    // let commonSymbols = ['A', 'B', 'C', 'P', 'Q', 'r', 's', 'i', 'j', 'k' ];
    if (commonVars.includes(ch)) {
      super_.init.call(this, ch, '<var class="common-vars">'+(html || ch)+'</var>');
    }
    // else if(commonSymbols.includes(html || ch)) {
    //   super_.init.call(this, ch, '<var class="common-symbols">'+(html || ch)+'</var>');
    // }
    else {
      super_.init.call(this, ch, '<var class="other-symbols">'+(html || ch)+'</var>');
    }
  };
  _.text = function() {
...
// var Variable = P(Symbol, function(_, super_) {
//   _.init = function(ch, html) {
//     super_.init.call(this, ch, '<var class="variable">'+(html || ch)+'</var>');
//   };
//   _.text = function() {
//     var text = this.ctrlSeq;
//     if (this[L] && !(this[L] instanceof Variable)
